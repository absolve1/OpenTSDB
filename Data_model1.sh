...
SOLA=( 'UU' 'WAWA' 'TD' 'PH' 'AA' 'DD' 'TA' 'NN' 'FF'  )
     ...
     if [ -z "$AUX" ]
      then
        echo "Missing value $VAR"
         ...
         METRIC="VALAND.weather."${arr[0]}
         QUALITY=${arr[1]}
         VALUE=${arr[2]}

       echo put $METRIC $starttimestamp $VALUE station=44640 quality_code=$QUALITY | nc -w 30 127.0.0.1 4242
   ...
   if [ -z "$AUX" ]
      then
        echo "Missing value $VAR"
         ...
         METRIC="SOLA.weather."${arr[0]}
         QUALITY=${arr[1]}
         VALUE=${arr[2]}


       echo put $METRIC $starttimestamp $VALUE station=44560 quality_code=$QUALITY | nc -w 30 127.0.0.1 4242
        echo "Timestamp: "$starttimestamp
        echo "Metric: "$METRIC
        echo "Value: "$VALUE
        echo "Quality: "$QUALITY
     ...
     if [ -z "$AUX" ]
      then
        echo "Missing value $VAR"
         ...
         METRIC="ROVIK.weather."${arr[0]}
         QUALITY=${arr[1]}
         VALUE=${arr[2]}


       echo put $METRIC $starttimestamp $VALUE station=44730 quality_code=$QUALITY | nc -w 30 127.0.0.1 4242
       echo "Timestamp: "$starttimestamp
        echo "Metric: "$METRIC
        echo "Value: "$VALUE
        echo "Quality: "$QUALITY
     ...
     if [ -z "$AUX" ]
      then
        echo "Missing value $VAR"
         ...
         METRIC="SAUDA.weather."${arr[0]}
         QUALITY=${arr[1]}
         VALUE=${arr[2]}


       echo put $METRIC $starttimestamp $VALUE station=46610 quality_code=$QUALITY | nc -w 30 127.0.0.1 4242
       echo "Timestamp: "$starttimestamp
        echo "Metric: "$METRIC
        echo "Value: "$VALUE
        echo "Quality: "$QUALITY
     ...
     if [ -z "$AUX" ]
      then
        echo "Missing value $VAR"
         ...
         METRIC="NESET.weather."${arr[0]}
         QUALITY=${arr[1]}
         VALUE=${arr[2]}


       echo put $METRIC $starttimestamp $VALUE station=39750 quality_code=$QUALITY | nc -w 30 127.0.0.1 4242
       echo "Timestamp: "$starttimestamp
        echo "Metric: "$METRIC
        echo "Value: "$VALUE
        echo "Quality: "$QUALITY
     ...
     if [ -z "$AUX" ]
      then
        echo "Missing value $VAR"
         ...
         METRIC="ARENDAL.weather."${arr[0]}
         QUALITY=${arr[1]}
         VALUE=${arr[2]}


       echo put $METRIC $starttimestamp $VALUE station=36330 quality_code=$QUALITY | nc -w 30 127.0.0.1 4242
       echo "Timestamp: "$starttimestamp
        echo "Metric: "$METRIC
        echo "Value: "$VALUE
        echo "Quality: "$QUALITY
